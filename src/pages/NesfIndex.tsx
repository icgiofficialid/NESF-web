        ...
        <div className="container flex flex-col md:flex-row items-center gap-6">
          <div className="flex-1 space-y-3">
            ...
            <p className="text-muted-foreground text-sm leading-7 max-w-2xl">
              {lang === "en"
                ? "NESF (National Engineering Science Fair) is ICGI's national-level academic competition platform, designed to spotlight engineering ingenuity, scientific exploration, and applied research from Indonesia's brightest young minds. NESF is the national counterpart to IESF."
                : "NESF (National Engineering Science Fair) adalah platform kompetisi akademik nasional ICGI, dirancang untuk menyoroti kecerdasan teknik, eksplorasi ilmiah, dan penelitian terapan dari generasi muda terbaik Indonesia. NESF adalah pasangan nasional dari IESF."}
            </p>
          </div>
          <div className="flex gap-4">
            {[
              { label: { en: "IESF\nInternational", id: "IESF\nInternasional" }, color: BLUE, href: "https://iesfofficial.or.id" },
